   ...
   <?php include("sidebar.php"); ?>
        <div class="main-panel">
		  ...
		  <?php if(isset($_SESSION['msg'])){ echo '<div class="business-warning"><p></p> </div>';}?>
            ...
            <div class="edit-profile-img">
                <div class="circle">
				<?php 
                          $pro=$profile->getwheredata('user', 'id', $_GET['id']); 
	  ...
	  <div class="col-md-12">
				     <div class="input-field">
					  ...
					  <input type="text" class="" name="name" value="<?php echo $pro[0]['name'];?>" disabled>
					 </div>
	 </div>
	  <div class="col-md-6">
	  <div class="input-field">
					  <label class="input-label">Email  <sup> *</sup></label>
					  <input type="mail" class=""  name="email" value="<?php echo $pro[0]['email'];?>" disabled>
					 </div>
	 </div>
	 	 <div class="col-md-6">
	  <div class="input-field">
					  <label class="input-label">Mobile Number  <sup> *</sup></label>
					  <input type="text" class="" name="mobile" value="<?php echo $pro[0]['mobile'];?>" disabled>
					 </div>
	 </div> <div class="col-md-6">
				     <div class="input-field">
					  <label class="input-label"> State<sup> *</sup></label>
					  <input type="text" class="" name="mobile" value="<?php echo $pro[0]['state'];?>" disabled>
					 </div>
				   </div>
				   <div class="col-md-6">
				     <div class="input-field">
					  <label class="input-label">Local Government Authority  <sup> *</sup></label>
					  <input type="text" class="" name="mobile" value="<?php echo $pro[0]['government'];?>" disabled>
					 </div>
				   </div>
	 <div class="col-md-12">
				     <div class="input-field">
					  <label class="input-label">Address 1  <sup> *</sup></label>
					  <input type="text" class="" name="address1" value="<?php echo $pro[0]['address1'];?>"  disabled>
					 </div>
	 </div>
	  <div class="col-md-12">
				     <div class="input-field">
					  <label class="input-label">Address 2  <sup> *</sup></label>
					  <input type="text" class="" name="address2" value="<?php echo $pro[0]['address2'];?>" disabled>
					 </div>
	 </div>
	 <div class="col-md-12">
				     <div class="input-field">
					  <label class="input-label">About You <sup> *</sup></label>
					  <input type="text" class="" name="about" value="<?php echo $pro[0]['about'];?>"  disabled>
					 </div>
	 </div>
	 <div class="col-md-12">
				  <div class="submit-form-btn">
				  <a href="userindex.php" class="btn btn-success" >Go To Deshboard</a>
				  <a href="bizcards.php" class="btn btn-info" >Bizcards</a>
				 </div>
				  </div>
	 </div>
	 </form>
            ...
            <div class="edit-profile-img">
				...
				<?php 
                          $pro=$profile->getwheredata('user', 'id', $_SESSION['id']);
                                if($pro['image']!=''){echo '<img class="profile-pic" src="images/user/'.$pro[0]['image'].'" alt="">';}else{echo '<img class="profile-pic" src="images/edit-pic.png" alt="">';} ?>
            ...
            for($i=0;$i<1;$i++){ 
                echo '<option value="'.$row['state'].'" >'.$row['state'].'</option>';
				   ...
				   <div class="col-md-6">
				     <div class="input-field">
					  <label class="input-label">Local Government Authority  <sup> *</sup></label>
					  <select  name="area" id="government"  required>
