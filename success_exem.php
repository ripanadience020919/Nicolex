<?php include("userheader.php"); 
 ...
 <!-- partial -->
   ...
   <div class="success-part">
			 ...
			 <?php if($_GET['text']=='b'){
  $crntbussiness=$currentsave->getwheredata('business_exemptions', 'id', $_GET['id']);
			...
			<div class="dashboard-table-list inner-business-list-table  pybill-table-list" style=" margin-top: 50px; margin-bottom: 50px; text-align: justify;">
			  <div class="row">
			    ...
			    <div class="col-md-1"></div>
                         ...
                         <?php } } if($_GET['text']=='v'){	
				  $crntvehcle=$currentsave->getwheredata('vehicle_exemption', 'id', $_GET['id']);
  foreach ($crntvehcle as $crntvhl) { ?>
			<div class="dashboard-table-list inner-business-list-table  pybill-table-list" style=" margin-top: 50px; margin-bottom: 50px; text-align: justify;">
			 ...
			 <?php } 
                                ...
                                $crntproperty=$currentsave->getwheredata('property_exemption', 'id', $_GET['id']);
			...
			<div class="dashboard-table-list inner-business-list-table  pybill-table-list" style=" margin-top: 50px; margin-bottom: 50px; text-align: justify;">
			  <div class="row">
			    ...
			    <div class="col-md-1"></div>
                          ...
                          <?php } } 
                          if($_GET['text']=='b'){$text='business_exemption';}
                          elseif($_GET['text']=='v'){ $text='vehicle_exemption'; }
                          elseif($_GET['text']=='p'){ $text='property_exemption'; }
                          ?>
              <div class="row">
              	<div class="col-md-4">
				 </div>
				 <div class="col-md-4">
				 	<a href="userindex.php"  style="background: #b5332b;">Return to deshboard</a>
				 </div>
				 <div class="col-md-4">
				 </div>
			 </div>
