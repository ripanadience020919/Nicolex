            ...
            <div class="page-header">
              <h3 class="page-title">Official E-Receipt</h3>
				 ...
				 <?php 	
                     ...
                     $paymentbill = $paybill->getwheredata('business_bill', 'receiptno', $_GET['receiptno']);                                     
		  ...
		  <div class="table-all-see-btn business-inner-button">
			  ...
			  <div class="watermark-bill"><img src="images/watermark.png" alt=""></div>
			   ...
			   <?php } ?>
				 ...
				 $paymentbill = $paybill->getwheredata('vehicle_bill', 'receiptno', $_GET['receiptno']);                                    
                     foreach ($paymentbill as $value) {
                         for($i=0;$i<1;$i++){
                      ?><div class="dashboard-table-list inner-business-list-table  pybill-table-list">
			  <div class="row">
...
<div class="table-all-see-btn business-inner-button">
			  ...
			  <?php if($_GET['type']=='property'){	
				 $paymentbill = $paybill->getwheredata('property_bill', 'receiptno', $_GET['receiptno']);                                    
                     foreach ($paymentbill as $value) {
                         for($i=0;$i<1;$i++){  ?>
			<div class="dashboard-table-list inner-business-list-table  pybill-table-list">
			  <div class="row">
