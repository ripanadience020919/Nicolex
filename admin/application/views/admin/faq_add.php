                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"><?=$display?>  FaQ</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title"><?=$display?>  FaQ</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="question"  name="question" class="form-control" value="<?php if(!empty($list->question)) { echo $list->question; } ?>" placeholder="Question" required>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea id="answer"  name="answer" class="form-control" placeholder="Answer" rows="10" required><?php if(!empty($list->answer)) { echo $list->answer; } ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="text-center mb-3">
                                    <a href ="<?php echo base_url();?>home/faq_list" class="btn w-sm btn-danger waves-effect">Cancel</a>
