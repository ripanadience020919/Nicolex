                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">All Property Exemptions</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">All Property Exemptions</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td>
                                                        <a href="<?php echo base_url()?>home/approve_p_exem/<?php echo $val['id'];?>/<?php echo $val['userid'];?>"><button type="button" class="btn btn-success btn-sm waves-effect waves-light">Approved</button></a>
                                                        <a href="<?php echo base_url()?>home/deny_p_exem/<?php echo $val['id'];?>/<?php echo $val['userid'];?>"><button type="button" class="btn btn-danger btn-sm waves-effect waves-light">Deny</button></a>
                                                    </td>
                                                    <?php
                                                        }
                                                    ?>
