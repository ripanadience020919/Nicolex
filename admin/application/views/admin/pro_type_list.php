                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Type Of Property List</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Type Of Property List</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="<?php  echo base_url();?>home/add_property_type"><button type="button"
                                        ...
                                        <table id="datatable-buttons"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $val['typeofproperty']; ?>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="<?= base_url() . 'home/add_property_type/' . $val['id']; ?>"><button
                                                                type="button"
                                                        ...
                                                        <a
                                                            href="<?= base_url() . 'home/delete_property_type/' . $val['id']; ?>"><button
                                                                type="button"
