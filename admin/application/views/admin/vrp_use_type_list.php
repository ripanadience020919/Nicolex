                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Use Type Of Vehicle Radio & Parking List</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Use Type Of Vehicle Radio & Parking List</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="<?php  echo base_url();?>home/add_vrp_use_type"><button type="button"
                                        ...
                                        <table id="datatable-buttons"
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>Sl No.</th>
                                                    <th>Use Type Of Vehicle Radio & Parking</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $val['usetypeofvrp']; ?>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="<?= base_url() . 'home/add_vrp_use_type/' . $val['id']; ?>"><button
                                                                type="button"
                                                        ...
                                                        <a
                                                            href="<?= base_url() . 'home/delete_vrp_use_type/' . $val['id']; ?>"><button
                                                                type="button"
