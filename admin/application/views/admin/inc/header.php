                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                        <a href="<?php echo base_url();?>home/businessexemptionslist" class="dropdown-item"> Business Exemption</a>
                                        <a href="<?php echo base_url();?>home/vrpexemptionslist" class="dropdown-item"> Vehicle Radio & Parking Permit Exemption</a>
                                        <a href="<?php echo base_url();?>home/propertyexemptionslist" class="dropdown-item"> Property Exemption</a>
                                    </div>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                        <a href="<?php echo base_url();?>home/user_add" class="dropdown-item"> User Add </a>
                                        <a href="<?php echo base_url();?>home/user_list" class="dropdown-item"> User List </a>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                        <a href="<?php echo base_url();?>home/query_list" class="dropdown-item"> Query List </a>
                                    </div>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                        <a href="<?php echo base_url();?>home/payment_analysis" class="dropdown-item">Payment Analysis</a>
                                    </div>
                                </li>
                                <?php
                                        }
