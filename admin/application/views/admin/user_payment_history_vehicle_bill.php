                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <!-- `ownername`, `vehicleregistrationno`, `chasisno`, `vehiclemake`, `manufactureyear`, `government`, `state`, `usetype`, `validityyear`, `createat`, `updateat`, `receiptno`, `amount`, `paymenttype`, `cardno`, `expiredate`, `codecvv`, `cardholdername`, `paymentdate`, `qrcode`, `walletid`, `vid`, `description`, `address`, `mobile` -->
                                                <tr>
                                                    <td><?php echo $key+1;?></td>
                                                    <td><?=$val['ownername'];?></td>    
                                                    <td><?=$val['vehicleregistrationno'];?></td>    
                                                    <td><?=$val['chasisno'];?></td>    
                                                    <td><?=$val['vehiclemake'];?></td>    
