                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">  Info Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="title"  name="title" class="form-control" value="<?php if(!empty($list->title)) { echo $list->title; } ?>" placeholder="Question" required disabled>
                                            </div>
                                          </div>
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea id="description"  name="description" class="form-control" placeholder="Answer" rows="10" required disabled><?php if(!empty($list->description)) { echo $list->description; } ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="text-center mb-3">
                                    <a href ="<?php echo base_url();?>home/info_list" class="btn w-sm btn-danger waves-effect">Back</a>
