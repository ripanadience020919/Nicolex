            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php
                            if (!empty($rev)) {
                    ?>
                    <form action="<?php echo base_url();?>home/store_Bus_type" method="post"
                        ...
                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="bus_type" name="bus_type" class="form-control"
                                                    ...
                                                    value="<?php if(!empty($rev['typeofbusiness'])){echo $rev['typeofbusiness'];} ?>"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="text-center mb-3">
                                    <a href="<?php echo base_url();?>home/business_type"
