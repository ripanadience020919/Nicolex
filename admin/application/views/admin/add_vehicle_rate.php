...
<?php 
  ...
  $submit_url = ($user_id=='ADD') ? base_url('home/add_vehicle_rate_data') : base_url('home/edit_vehicle_rate_data') ;
?>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                                ...
                                                <select class="form-control" name="type" id="type">
                                                    ...
                                                    if ($user_id=='ADD') 
                                                    {
                                                        if (!empty($type)) 
                                                        {
                                                            ...
                                                            {
                                                                ?>
                                                                <option value="<?php echo $value['usetypeofvrp']; ?>"><?php echo $value['usetypeofvrp']; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                    }
                                                    else
                                                    {
                                                        if (!empty($type)) 
                                                        {
                                                            foreach ($type as $key => $value)
                                                            {
                                                                if ($value['usetypeofvrp'] == $list->type)
                                                                {
                                                                    $c = "selected";
                                                                }
                                                                else
                                                                ...
                                                                ?>
                                                                <option value="<?php echo $value['usetypeofvrp']; ?>"<?php echo $c; ?>><?php echo $value['usetypeofvrp']; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                    } 
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="product-name">rate<span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                <div class="text-center mb-3">
                                    <a href ="<?php echo base_url();?>home/vehicle_rate" class="btn w-sm btn-danger waves-effect">Cancel</a>
...
<script type="text/javascript">
    if ('<?=$user_id?>'!='ADD') {
        ...
        document.getElementById("rate").value = "<?=$list->rate?>";
        setTimeout(function(){
          getGOVT_edit();
        }, 1000);
    }
    ...
    { 
        ...
        var url2="<?php echo base_url(); ?>home/get_govt2";
        $.ajax({
          type: "POST",
