                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Upload Property Rate CSV</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Upload Property Rate CSV</h4>

                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    <form action="<?php echo base_url();?>csv_import/import_pro_rate_csv" method="post"
                            ...
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label for="product-name">Upload Property Rate CSV<span
                                                        class="text-danger">*</span></label>
                                                <a href="<?php  echo base_url();?>assets/admin/uploads/csv/Property_rate_csv_format.csv" download><button type="button"
