...
if($_POST['code']){
    $id=$_POST['code'];
     header("location:permit_details.php?text=e&id=".$id."");}else{ echo "<script>alert('Something wrong');</script>";
        }
    }
}
...
{ $perno='+234'.$_POST['pno']; $bsno='+234'.$_POST['bno'];
...
if($sql){
    $id=$sql;
     header("location:success_exem.php?text=b&id=".$id."");}else{ echo "<script>alert('Something wrong');</script>";
        }
    }
}
...
?>   
   ...
   <div class="main-panel">
          <div class="content-wrapper">
            ...
            <input type="radio" id="exemption-register" name="new-register" value="exemption-register" <?php if(isset($_GET['text']) && $_GET['text']=='e'){ echo 'checked'; }?>> <label for="exemption-register">Exemption</label>
			</div>
			     ...
			     <div class="row">
					  ...
					  <input type="text" class="" name="pname" required>
				   	...
				   	<div class="col-md-6">
                        <div class="input-field"  id="mobilecode">
							 ...
							 <span class="btn btn-secondary">+234</span><input type="tel" class="" name="pno" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" maxlength="10" size="10"  required>
						</div>				     
				   	</div>
				     <div class="col-md-6">
				     <div class="input-field">
				   ...
				   <div class="col-md-6">
                    <div class="input-field"  id="mobilecode">
					 ...
					 <span class="btn btn-secondary">+234</span><input type="tel" class="" name="bno" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" maxlength="10" size="10" required >
					 </div>
				   </div> 
				 <div class="col-md-6">
				     <div class="input-field">
			   ...
			   <form class="business-form"  method="post" action="" enctype="multipart/form-data">
			     <div class="row">
				  ...
				  <label class="input-label">Owner’s Contact Tel. <sup> *</sup></label>
					 <span class="btn btn-secondary">+234</span><input type="tel" class="" name="mobile" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" maxlength="10" size="10" required >
					 </div>
				   </div>
				   <div class="col-md-6">
				     <div class="input-field">
			 ...
			 <div class="exemption-register business-new <?php if(isset($_GET['text']) && $_GET['text']=='e'){ echo 'show" style="display: block;"'; }?>"><br>
			 	<div class="radio-button-choose business-button-choose">
			    ...
			    <form class="exemption-form"  method="post" action="" enctype="multipart/form-data" id="form1">
				 ...
				 <div class="col-md-6">
				   ...
				   <div class="col-md-12">
				     <div class="input-field">
					  <label class="input-label">Tell Us Why Your Business Need An Exemption <sup> *</sup></label>
			   ...
			   <form class="exemption-form"  method="post" action="" enctype="multipart/form-data" id="form3">
			     <div class="row">
				   ...
				   <div class="col-md-12">
				     <div class="input-field">
					  <label class="input-label">Tell Us Why Your Property Need Exemption   <sup> *</sup></label>
					   <input type="text" class="" name="tell_us" required>
					 </div>
				   </div>
