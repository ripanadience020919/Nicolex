...
<html lang="en">
  <head>
    ...
    <title>Reset Password | Nicolex User Panel</title>
    <!-- plugins:css -->
	      ...
	      <div class="row">
			...
			<div class="col-md-12">
			 <div class="login-heading">
			  <h3><span > Enter Your </span> New Password</h3>
			 </div>
			   <?php 
...
if($_POST['npass']!='' && $_POST['cpass']!=''){
    ...
    $login=new Users;
    $lg=$login->update_password($_GET['id'],$cpass);    
    if($lg ==true)
    {
    ...
    { 
    	echo '<div class="business-warning"><p>Password Not Matched.</p></div>'; 
    }
    }
    else
    {
